...
class Biblioteca:
    ...
    def buscar_libro(self, opc_search):
        try:
            ...
            match = [
            libro for libro in registros
            if libro['titulo'].lower() == opc_search.lower() or
               (opc_search_int is not None and libro['isbn'] == opc_search_int)
            ]
            ...
            else: print("No se encontro el registro...")
    ...
    def eliminar_libro(self, isbn_search):
        try:
            ...
            nuevo_registro = [libro for libro in registros if libro['isbn'] != isbn_search]
